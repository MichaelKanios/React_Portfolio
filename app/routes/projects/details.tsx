...
export async function clientLoader ({request,params}:Route.ClientLoaderArgs):Promise<Project>{
    const res = await fetch(`https://upgraded-space-succotash-gx46j6wvvw63wjgp-3000.app.github.dev/projects/${params.id}`);
...
const ProjectDetailsPage = ({loaderData}:Route.ComponentProps) => {
    ...
    return ( 
    <>
        <Link to="/projects" className="flex items-center text-blue-400
         hover:text-blue-500 mb-6 transition">
